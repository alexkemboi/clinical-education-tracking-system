    ...
    <>
      ...
      <div className="container my-5">
        <form>
          <div className="form-group">
            <h3>
              <i className="fas fa-graduation-cap"></i> Educational Information
            </h3>
            <hr />
      ...
      <div className="container my-5">
        <form>
          <div className="form-group">
            <h3>
              <i className="fas fa-hospital"></i> Clinical Education Information
            </h3>
            <hr />
        ...
        <form>
          <div className="form-group">
            ...
            <label htmlFor="allergies-medical-conditions">
              <i className="fas fa-notes-medical"></i> Do you have any allergies
              or medical conditions that we should be aware of?
            </label>
            ...
            <div className="form-group">
              <label htmlFor="allergies-medical-conditions-specify">
                <i className="fas fa-notes-medical"></i> If yes, please specify:
              </label>
              <textarea
                className="form-control"
